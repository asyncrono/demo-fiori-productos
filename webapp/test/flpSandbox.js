		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Productos",
									"targetURL": "#comdemoproducts-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comdemoproducts-display": {
								"semanticObject": "comdemoproducts",
								"action": "display",
								"description": "Demo app Productos",
								"title": "Productos",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.demo.products",
									"url": sap.ui.require.toUrl("com/demo/products")
								}
							}
						}
					}
